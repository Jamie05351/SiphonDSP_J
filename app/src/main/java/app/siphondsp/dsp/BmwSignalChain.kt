...
object BmwSignalChain {
     ...
     * - Extended: 144 values (added the UI-only Link L/R Delay toggle)
     * - Current: 192 values (added the pre-crossover multiband compressor + per-bus output
     *   limiter block at 144..187; 188 legacy-compressor-disabled marker; 189..191 master limiter
     *   enable/threshold/marker)
     * - The Pultec stage was removed as unused; the count did not shrink back down. All 4 of its
     *   slots were since reclaimed in place: 139 = meas-mute stopband octaves, 140 = its migration
     *   marker, 141 = Mid-band independent LPF enable, 142 = Mid-band independent LPF corner Hz.
     *
