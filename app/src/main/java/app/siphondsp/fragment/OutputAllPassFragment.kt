...
class OutputAllPassFragment : Fragment() {
    ...
    private fun rebuild() {
        ...
        // TEMPORARY (Phase 3 slider verification): stacks the slider demo above the real
        ...
        stack.addView(sliderDemoView, LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT))
