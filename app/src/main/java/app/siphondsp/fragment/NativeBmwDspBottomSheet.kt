...
class NativeBmwDspBottomSheet : BottomSheetDialogFragment() {
    ...
    private fun switchCard(title: String, subtitle: String?, index: Int) {
        ...
        val labels = labelBlock(title, subtitle)
        content.addView(labels, LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.WRAP_CONTENT, 1f))
    ...
    private fun labelBlock(title: String, subtitle: String?): LinearLayout = LinearLayout(requireContext()).apply {
        orientation = LinearLayout.VERTICAL
