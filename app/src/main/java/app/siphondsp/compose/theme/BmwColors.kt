...
val BmwDashboardColors = BmwColors(
    ...
    highBandPink = Color(BmwDashboardSkin.HIGH_BAND_PINK),
    ...
    sliderHighBand = Color(BmwDashboardSkin.SLIDER_HIGH_BAND_COLOR),
