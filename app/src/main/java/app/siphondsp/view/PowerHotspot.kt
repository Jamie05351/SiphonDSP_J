 ...
 * so MainActivity's power logic is unchanged. While toggled on it paints a green power symbol
 * over the artwork's own white one, and lights [linkedLed] (the small dot under the button).
 */
